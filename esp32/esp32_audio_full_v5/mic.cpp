...
bool mic_process(int16_t *outBuffer, int *samplesOut, bool *isSpeaking)
{
  ...
  else
  {
    ...
    // 🔥 mantém fala após pequenas pausas
    if (millis() - lastVoiceTime < 600)
    {
      speakingNow = true;
    }
    else
